...
OPTIONAL_PAYLOAD_FIELDS = {
    ...
    OBJECT_UPDATE: ("player_id", "room_id"),
    WORLD_DELTA: ("player_id",),
    OBJECT_OWNERSHIP: ("player_id",),
    INTERACTION_REQUEST: ("args", "affordance_id", "affordance", "target"),
    INTERACTION_START: ("args", "affordance_id", "affordance", "target"),
    SAVE_PUSH: ("origin",),
    SAVE_ACK: ("message",),
